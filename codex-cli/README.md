...
|--------|-------------|---------|
| `codex-bashhistory-${devcontainerId}` | `/commandhistory` | Bash/ZSH command history |
| `codex-config-${devcontainerId}` | `/home/node/.codex` | Codex CLI configuration and cache |
...
| `CODEX_CONFIG_DIR`              | `/home/node/.codex`           | Codex CLI config directory                             |
...
- `openai.chatgpt` - OpenAI ChatGPT extension
